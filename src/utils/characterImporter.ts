  ...
  static importCharacter(jsonData: string): Character {
    try {
      ...
      const mappedCharacter: Character = {
        ...
        spells: {
          class: characterData.classSpells?.map((spell: any) => ({
            id: spell.id,
            name: spell.definition.name,
            level: spell.level,
            school: spell.definition.school,
            castingTime: spell.definition.castingTime,
          ...
          race: characterData.raceSpells?.map((spell: any) => ({
            id: spell.id,
            name: spell.definition.name,
            level: spell.level,
            school: spell.definition.school,
          ...
          item: characterData.ItemSpells?.map((spell: any) => ({
            id: spell.id,
            name: spell.definition.name,
            level: spell.level,
            school: spell.definition.school,
